! function t(e, a, r) {
	...
	2: [function(t, e, a) {
		...
		function r(t) {
			return t.endsWith("kb") ? 1024 * parseInt(t) : t.endsWith("mb") ? 1024 * parseInt(t) * 1024 : t.endsWith("gb") ?
				1024 * parseInt(t) * 1024 * 1024 : void 0
		}
		...
		a.validationFn = {
			...
			mobile: function(t) {
				return !!/^1[3|4|5|7|8][0-9]{9}$/.test(t.value)
			},
			pattern: function(t) {
	...
	3: [function(t, e, a) {
		...
		var r = t("./validations"),
			...
			i = function(t) {
				t.forEach(function(t, e) {
					var a = $(t).parent("form").attr("data-uid"),
						r = "blur";
					$(t).attr("data-uid", a + "-field-" + e), "file" == $(t).attr("type") && (r = "change"), $(t).on(r, function(
						e) {
						u(t)
					})
				})
			...
			u = function(t) {
				var e = !0;
				if ($(t).attr("required") && (e = "checkbox" == $(t).attr("type") ? e ? o(t, "checked", r.validationFn.required,
						"You need to check this") : e : e ? o(t, "value", r.validationFn.required, "This field is required") : e),
					"email" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.email, "The email is invalid") : e),
					"url" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.url, "The url is invalid") : e), "mobile" ==
					$(t).attr("type") && (e = e ? o(t, "value", r.validationFn.mobile, "The mobile number is invalid") : e), $(t).attr(
						"pattern") && (e = e ? o(t, "value", r.validationFn.pattern, "Please match the requested pattern") : e), $(t).attr(
						"data-match-field") && (e = e ? o(t, "value", r.validationFn.match, $(t).attr("data-match") +
						" fields does not match") : e), "file" == $(t).attr("type")) {
					if ($(t).attr("data-file-types") && (e = e ? o(t, "", r.validationFn.fileTypes, "Invalid file type selected") :
							e), $(t).attr("data-file-max-size")) {
			...
			o = function(t, e, a, r) {
				...
				return r = $(t).attr("data-error") || r, a({
					...
					property: e,
					value: $(t).prop(e)
				}) ? ($(t).addClass("no-error"), $(t).removeClass("error"), n.remove(), !0) : ($(t).addClass("error"), $(t).removeClass(
					"no-error"), n.innerHTML = r, !1)
			},
			l = function(t) {
				var e = $(t).attr("data-uid") + "-error",
					a = void 0;
				return 0 == $("#" + e).length ? ((a = document.createElement("div")).setAttribute("id", e), a.className =
					"error-field", $(t).after(a)) : a = document.getElementById(e), a
			}
	}, {
		"./validations": 2
	}]
