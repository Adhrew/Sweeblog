! function t(e, a, r) {
	...
	3: [function(t, e, a) {
		...
		var r = t("./validations"),
			...
			u = function(t) {
				var e = !0;
				if($(t).attr("required") && (e = "checkbox" == $(t).attr("type") ? e ? o(t, "checked", r.validationFn.required, "You need to check this") : e : e ? o(t, "value", r.validationFn.required, "此处为必填项") : e), "email" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.email, "The email is invalid") : e), "url" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.url, "手机号码无效") : e), "mobile" == $(t).attr("type") && (e = e ? o(t, "value", r.validationFn.mobile, "手机号码无效") : e), $(t).attr("pattern") && (e = e ? o(t, "value", r.validationFn.pattern, "Please match the requested pattern") : e), $(t).attr("data-match-field") && (e = e ? o(t, "value", r.validationFn.match, " 密码字段不匹配") : e), "file" == $(t).attr("type")) {
				...
				if($(t).attr("maxlength")) {
					...
					e = e ? o(t, "value", r.validationFn.maxLength, "密码应该小于 " + l + "长度") : e
				}
				if($(t).attr("minlength")) {
					var f = $(t).attr("minlength");
					e = e ? o(t, "value", r.validationFn.minLength, "密码应该大于" + f + "长度") : e
				}
				return e
			},
			o = function(t, e, a, r) {
