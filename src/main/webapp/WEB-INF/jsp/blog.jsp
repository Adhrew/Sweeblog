	...
	<head>
		...
		$(document).ready(function(){
				...
				layui.use([ 'laypage', 'layer' ], function() {
				  ...
				  +"</div></div><div class='col blogdata_1_of_2'><div class='blog_data'><p></p><div class='more'><span><a class='button outline-outward hvr-rectangle-in' href='Chat.html?user_id="+${sessionScope.userSession.user_id}+"&sender_id="
				  +data.data[i].user_id.user_id+"' target='_blank'>联系博主</a></span>"
