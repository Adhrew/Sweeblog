...
public class UserController {
    ...
    public static SendSmsResponse sendSms(@RequestParam("phone")String phone) throws ClientException {
	...
	public void register(@RequestParam("username")String username,@RequestParam("pwd") String password,@RequestParam("phone") String phone,@RequestParam("identifyingcode") String identifyingcode,Model model,HttpSession session, HttpServletRequest request,HttpServletResponse response) throws Exception {
